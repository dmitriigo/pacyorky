<template>
    <div style="width: 100%; padding: 50px;">
        ...
        <h4>Effective date: 2020-03-27</h4>
        <h3>1. Introduction</h3>
        <p>Welcome to MTU Ukraina kaasmaalaskond Sillamae Vodograi.
            MTU Ukraina kaasmaalaskond Sillamae Vodograi (“us”, “we”, or “our”) operates https://pacyorky.ee (hereinafter
            referred to as “Service”).
            Our Privacy Policy governs your visit to https://pacyorky.ee, and explains how we collect, safeguard and
        ...
        <p>
        <ul>
            <li>SERVICE means the https://pacyorky.ee website operated by MTU Ukraina kaasmaalaskond Sillamae Vodograi.</li>
            <li>PERSONAL DATA means data about a living individual who can be identified from those data (or from those and
                other information either in our possession or likely to come into our possession).
            </li>
            <li>USAGE DATA is data collected automatically either generated by the use of Service or from Service
                infrastructure itself (for example, the duration of a page visit).
            </li>
            <li>COOKIES are small files stored on your device (computer or mobile device).
            </li>
            <li>DATA CONTROLLER means a natural or legal person who (either alone or jointly or in common with other
            ...
            <li>DATA PROCESSORS (OR SERVICE PROVIDERS) means any natural or legal person who processes the data on behalf of
                the Data Controller. We may use the services of various Service Providers in order to process your data more
                effectively.
            </li>
            <li>DATA SUBJECT is any living individual who is the subject of Personal Data.
            </li>
            <li>THE USER is the individual using our Service. The User corresponds to the Data Subject, who is the subject
                of Personal Data.
            </li>
        </ul>
        ...
        <p>Usage Data
            ...
            Service by or through any device (“Usage Data”).
        ...
        <ul>
            ...
            <li>0.4. Advertising Cookies: Advertising Cookies are used to serve you with advertisements that may be relevant
        ...
        <h3>5. Use of Data</h3>
        <p>MTU Ukraina kaasmaalaskond Sillamae Vodograi uses the collected data for various purposes:</p>
        <ul>
            <li>0.1. to provide and maintain our Service;
            </li>
            <li>0.2. to notify you about changes to our Service;
            </li>
            ...
            <li>0.5. to gather analysis or valuable information so that we can improve our Service;
            </li>
            <li>0.6. to monitor the usage of our Service;
            </li>
            <li>0.7. to detect, prevent and address technical issues;
            </li>
            <li>0.8. to fulfil any other purpose for which you provide it;
            </li>
            <li>0.9. to carry out our obligations and enforce our rights arising from any contracts entered into between you
                and us, including for billing and collection;
            </li>
            <li>0.10. to provide you with notices about your account and/or subscription, including expiration and renewal
                notices, email-instructions, etc.;
            </li>
            <li>0.11. to provide you with news, special offers and general information about other goods, services and
        ...
        <p>Your information, including Personal Data, may be transferred to – and maintained on – computers located outside
            ...
            If you are located outside European Union and choose to provide information to us, please note that we transfer
            the data, including Personal Data, to European Union and process it there.
            Your consent to this Privacy Policy followed by your submission of such information represents your agreement to
            that transfer.
            MTU Ukraina kaasmaalaskond Sillamae Vodograi will take all the steps reasonably necessary to ensure that your
        ...
        <ul>
            <li>0.1. Business Transaction.
                If we or our subsidiaries are involved in a merger, acquisition or asset sale, your Personal Data may be
                transferred.
            </li>
            <li>0.2. Other cases. We may disclose your information also:
            </li>
            <li>0.2.1. to our subsidiaries and affiliates;
            </li>
            <li>0.2.2. to contractors, service providers, and other third parties we use to support our business;
            </li>
            <li>0.2.3. to fulfill the purpose for which you provide it;
            </li>
            <li>0.2.4. for the purpose of including your company’s logo on our website;
            </li>
            <li>0.2.5. for any other purpose disclosed by us when you provide the information;
            </li>
            <li>0.2.6. with your consent in any other cases;
            </li>
            <li>0.2.7. if we believe disclosure is necessary or appropriate to protect the rights, property, or safety of
        ...
        <h3>17. Contact Us</h3>
        <p>
            If you have any questions about this Privacy Policy, please contact us by email: vodograi.estonia@gmail.com.
        </p>
    </div>
</template>
